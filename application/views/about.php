...
<div style="height:100%; width:100%; padding:50px;">
	...
	<div style="float:left; height:100%; width:40%; margin-right: 100px">
		</br>
		...
		<p style="font-size:18px">
			...
			<br/><br/>
			The project is using GitHub as version control to help manage
			and organize multiple versions of the projects developed by each member in the team.
			We will be given a grade for COMP4711 - Introduction to Internet Software Development based on the completion of the assignment.
		</p>
	</div>
	<div style="float:left; height:100%; width:30%">
		...
		<span style="color:#336699; font-weight:bold">Andrew Morishita</span></br>
